...
public class GreaterExpression implements BooleanExpression {
	...
	private final static Logger LOGGER = Logger.getLogger(GreaterExpression.class.getName());
		...
		if (this.expression1.getType() == Expression.INT) {
			...
			if (this.expression1.getType() == Expression.REAL) {
				...
				if ((londIDExpression1.getSymbol() != null) && (londIDExpression2.getSymbol() != null)) {
					...
					BooleanExpression simplifiedExpression = new LowerExpression(this.expression1, this.expression2)
							.toSimplifiedForm();
					((EnumSetExpressionSymbol) enumAttribute1.getSetExpressionSymbol())
