...
public class ExcludesExpression implements BooleanExpression {
	...
	public String toString() {
		return this.longID1 + " excludes " + this.longID2.toString();
	}
			...
			if (featuresSymbolTable.containsSymbol(longID2)) {
				...
				System.out
						.println("Type error : the expression "
								...
								+ longID2
								+ " ) is not a valid feature ID. In an excludes expression, each parameter must be a valid feature ID.");
			}
		} else {
			System.out
					.println("Type error : the expression "
	...
	public BooleanExpression toSimplifiedForm() {
		return new OrExpression(new NotExpression(new LongIDExpression(this.longID1, this.featuresSymbolTable)),
				new NotExpression(new LongIDExpression(this.longID2, this.featuresSymbolTable)));
	}
